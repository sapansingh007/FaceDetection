import 'dart:async';
import 'package:ai_face_authentication/pages/widgets/auth_button.dart';
import 'package:ai_face_authentication/pages/widgets/camera_detection_preview.dart';
import 'package:ai_face_authentication/pages/widgets/camera_header.dart';
import 'package:ai_face_authentication/pages/widgets/signin_form.dart';
import 'package:ai_face_authentication/pages/widgets/single_picture.dart';
...
class SignInState extends State<SignIn> {
  ...
  Future<void> onTap() async {
    ...
    if (_faceDetectorService.faceDetected) {
      ...
      if(user == null){
        setState(() {
          flutterTts.speak('User not found');
        });
      }else{
        setState(() {
          flutterTts.speak('User face match');
        });
      }
